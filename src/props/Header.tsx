...
const Header = () => {
    ...
    return(
      <div className=" bg-transparent w-full fixed overflow-hidden font-Bebas py-8 duration-500  z-50 "> 
        <div className='flex justify-between'>
        <svg width="150" height="30" viewBox="0 0 75 30" fill="none" className='pl-9' >
            ...
            <path d="M45.7331 28.1554C43.041 27.2532 40.6523 25.0263 41.0651 21.864C40.3562 18.9664 43.5357 15.2735 45.9501 18.1182C45.8594 20.4517 42.2746 18.2668 42.9015 21.2714C41.9487 24.915 45.4663 26.2984 48.1296 27.1238C49.4393 27.899 46.3405 28.9394 45.7327 28.1554H45.7331Z" className=' fill-black dark:fill-white duration-500 ease-in-out'/>
            ...
            <path d="M22.7577 25.2631C22.1627 22.375 23.2458 19.358 22.5371 16.5085C23.3546 13.6868 26.6551 16.8307 24.5137 18.637C24.4368 20.4603 22.7741 24.505 25.838 23.9249C25.9645 25.363 23.6325 26.2248 22.7577 25.2631L22.7577 25.2631Z" className=' fill-black dark:fill-white duration-500 ease-in-out'/>
            <path d="M24.4869 9.60501C23.0153 9.78458 20.9225 8.87799 22.839 7.48019C24.825 6.14354 27.032 9.39093 24.4869 9.60501Z" fill="black" className=' stroke-black dark:stroke-white duration-500 ease-in-out'/>
            </g>
            <defs>
